...
- ODM의 이하 attribute들로는 다음과 같이 존재하는데,
  ...
  * 21 CFR 11은 미국 의약품 의료기기 관리법률 중 전자 문서와 전자 서명에 관련한 규정이다. 
  ...
  ds:Signature 에서 다시 사용할 요소. 현재로써 서명을 위한 요소로 이해된다.
      ...
      이하 코드는 ODM 속성 예시코드.
      <ODM xmlns="http://www.cdisc.org/ns/odm/v1.3" xmlns:ns2="http://www.w3.org/2000/09/xmldsig#" FileType="Snapshot" FileOID="EXAMPLE_ODM study" CreationDateTime="2022-06-27T08:39:40.595Z" ODMVersion="1.3.2" SourceSystem="OpenEDC">    
